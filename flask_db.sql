...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-06-2024 a las 23:55:23
...
--
-- Estructura de tabla para la tabla `img_dataset`
--
...
--
-- Estructura de tabla para la tabla `prs_mstr`
--
...
--
-- Indices de la tabla `img_dataset`
--
ALTER TABLE `img_dataset`
  ADD PRIMARY KEY (`img_id`);

--
-- Indices de la tabla `prs_mstr`
--
